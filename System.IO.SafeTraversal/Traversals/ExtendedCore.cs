...
namespace System.IO.SafeTraversal
{
    public partial class SafeTraversal
    {
        ...
        private IEnumerable<FileInfo> TopLevelFilesTraversalWithSafetyCheck(DirectoryInfo path)
        {
            FileInfo[] files = null;
            try
            {
        ...
        private IEnumerable<FileInfo> TopLevelFilesTraversalWithSafetyCheck(DirectoryInfo path, Func<FileInfo, bool> filter)
        {
            IEnumerable<FileInfo> files = null;
            try
            {
        ...
        private IEnumerable<string> TopLevelFilesTraversalWithSafetyCheck(string path)
        {
            string[] files = null;
            try
            {
        ...
        private IEnumerable<string> TopLevelFilesTraversalWithSafetyCheck(string path, Func<FileInfo, bool> filter)
        {
            IEnumerable<string> files = null;
            try
            {
        ...
        private IEnumerable<FileInfo> TraverseFilesCoreWithSafetyCheck(DirectoryInfo path)
        {
            Queue<DirectoryInfo> directories = new Queue<DirectoryInfo>();
            directories.Enqueue(path);
            while (directories.Count > 0)
        ...
        private IEnumerable<FileInfo> TraverseFilesCoreWithSafetyCheck(DirectoryInfo path, Func<FileInfo, bool> filter)
        {
            Queue<DirectoryInfo> directories = new Queue<DirectoryInfo>();
            directories.Enqueue(path);
            while (directories.Count > 0)
        ...
        private IEnumerable<string> TraverseFilesCoreWithSafetyCheck(string path)
        {
            Queue<string> directories = new Queue<string>();
            directories.Enqueue(path);
            while (directories.Count > 0)
        ...
        private IEnumerable<string> TraverseFilesCoreWithSafetyCheck(string path, Func<FileInfo, bool> filter)
        {
            Queue<string> directories = new Queue<string>();
            directories.Enqueue(path);
            while (directories.Count > 0)
